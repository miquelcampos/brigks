...
class GuideActionsMenu(QMenu):
	...
	def __init__(self, tree, parent=None):
		...
		self.addSeparator()
		self.uiShowGdeACT = self.addAction("Show Guide")
		self.uiShowGdeACT.setShortcut(QKeySequence(Qt.CTRL|Qt.Key_H))
		self.uiShowRigACT = self.addAction("Show Rig")
		self.uiShowRigACT.setShortcut(QKeySequence(Qt.CTRL|Qt.Key_R))
		self.uiShowJntACT = self.addAction("Show Joints")
		self.uiShowJntACT.setShortcut(QKeySequence(Qt.CTRL|Qt.Key_J))
		self.uiShowCtlACT = self.addAction("Show Controllers")
		self.uiShowCtlACT.setShortcut(QKeySequence(Qt.CTRL|Qt.Key_C))
		self.addSeparator()
		self.uiHideGdeACT = self.addAction("Hide Guide")
		self.uiHideGdeACT.setShortcut(QKeySequence(Qt.Key_H))
		self.uiHideRigACT = self.addAction("Hide Rig")
		self.uiHideRigACT.setShortcut(QKeySequence(Qt.Key_R))
		self.uiHideJntACT = self.addAction("Hide Joints")
		self.uiHideJntACT.setShortcut(QKeySequence(Qt.Key_J))
		self.uiHideCtlACT = self.addAction("Hide Controllers")
		self.uiHideCtlACT.setShortcut(QKeySequence(Qt.Key_C))
